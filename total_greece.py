...
n = (100*D4)/10742599
print('\n\t\t3.3 Η θνησιμότητα είναι:','{0:.6f}'.format(n),'%')
...
k = (100*D2)/D1
print('\n\t\t6.1 Τα ενεργά κρούσματα είναι','{0:.2f}'.format(k),'%')
    
i = ((10000*a)/100)
print("\n\t7. Τα κρούσματα ανά 10 χιλιάδες πληθυσμού είναι:",'{0:.2f}'.format(i))
    
j = ((1000000*a)/100)
print("\n\t8. Τα κρούσματα ανά 1 εκατομμύριο πληθυσμού είναι:",'{0:.2f}'.format(j))
          
l = (100*D5)/247
print("\n\t9. Είναι κατηλλημένο το",'{0:.2f}'.format(l),"% των ΜΕΘ")

m = (100*D1)/D6
print('\n\t10. Πραγματοποιήθηκαν',D6,'δειγματοληψίες, από τις οποίες το','{0:.2f}'.format(m),"% ήταν θετικές")
