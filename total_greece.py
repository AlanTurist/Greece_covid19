...
print("\n\t1. Ο συνολικός αριθμός των κρουσμάτων είναι:",D1)
a = (100*D1)/10742599
...
f = (100*D5)/247
print("\n\t6. Είναι κατειλλημμένο το",'{0:.2f}'.format(f),"% των θέσεων ΜΕΘ")

g = (100*D1)/D6
print("\n\t7. Έχουν ελεγχθεί",D6,"δείγματα από τα οποία το",'{0:.2f}'.format(g),"% ήταν θετικά.")
